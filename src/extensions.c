...
static inline void dx_print(union dx dx) {
  ...
  printf("reserved: %d\n", dx.b.res1_);
  printf("AVX-512#New instructions in AVX-512 VP2INTERSECT|AVX-512 "
         "VP2INTERSECT Doubleword and Quadword Instructions: %d\n",
  ...
  printf("Platform configuration (Memory Encryption Technologies "
         "Instructions): %d\n",
         dx.b.pconfig);
  ...
  printf("Speculative Store Bypass Disable as mitigation for Speculative Store "
         "Bypass  (IA32_SPEC_CTRL): %d\n",
         dx.b.ssbd);
}
